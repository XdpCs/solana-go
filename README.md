...
[![GoDoc](https://pkg.go.dev/badge/github.com/MintyFinance/solana-go-custom?status.svg)](https://pkg.go.dev/github.com/MintyFinance/solana-go-custom@v1.12.0?tab=doc)
[![GitHub tag (latest SemVer pre-release)](https://img.shields.io/github/v/tag/gagliardetto/solana-go?include_prereleases&label=release-tag)](https://github.com/MintyFinance/solana-go-custom/releases)
[![Build Status](https://github.com/MintyFinance/solana-go-custom/workflows/tests/badge.svg?branch=main)](https://github.com/MintyFinance/solana-go-custom/actions?query=branch%3Amain)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/MintyFinance/solana-go-custom/main)](https://www.tickgit.com/browse?repo=github.com/MintyFinance/solana-go-custom&branch=main)
[![Go Report Card](https://goreportcard.com/badge/github.com/MintyFinance/solana-go-custom)](https://goreportcard.com/report/github.com/MintyFinance/solana-go-custom)
...
**If you're looking for a SERUM library, you can check out [gagliardetto/serum-go](https://github.com/gagliardetto/serum-go) ([./programs/serum](https://github.com/MintyFinance/solana-go-custom/tree/main/programs/serum) is deprecated.**)
...
```bash
$ cd my-project
$ go get github.com/MintyFinance/solana-go-custom@v1.12.0
```
...
You can wait for a transaction confirmation using the `github.com/MintyFinance/solana-go-custom/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
	...
	lookup "github.com/MintyFinance/solana-go-custom/programs/address-lookup-table"
...
import (
  ...
  "github.com/MintyFinance/solana-go-custom/rpc"
  "github.com/MintyFinance/solana-go-custom/rpc/jsonrpc"
)
...
import (
  ...
  "github.com/MintyFinance/solana-go-custom/programs/system"
  "github.com/MintyFinance/solana-go-custom/rpc"
  confirm "github.com/MintyFinance/solana-go-custom/rpc/sendAndConfirmTransaction"
  "github.com/MintyFinance/solana-go-custom/rpc/jsonrpc"
...
import (
  ...
  "github.com/MintyFinance/solana-go-custom/programs/token"
  "github.com/MintyFinance/solana-go-custom/rpc"
)
